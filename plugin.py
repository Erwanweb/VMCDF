...
class BasePlugin:
    def __init__(self):
        ...
        self._td_on = 0.5       # ΔTd pour enclenchement HUMIDE (°C)
        self._td_off = 0.2     # ΔTd pour arrêt HUMIDE (°C)
...
def compute_room_td_list(self):
    """
    Calcule Td (°C) pour chaque pièce humide listée dans hum_idxs.
    - Si le device expose Temp -> on l'utilise ; sinon fallback sur T_int moyenne.
    """
    Td_list = []
