...
<plugin key="ZZ-VMCDF" name="RONELABS - VMC DF Control" author="ErwanBCN" version="0.0.1" externallink="https://ronelabs.com">
    ...
    <params>
        ...
        <param field="Mode3" label="High speed relay(CSV List of idx)" width="200px" required="true" default=""/>
        <param field="Mode4" label="Low humidity threshold (e.g. 70)" width="100px" required="true" default=""/>
        <param field="Mode5" label="High humidity threshold (e.g. 85)" width="100px" required="true" default=""/>
